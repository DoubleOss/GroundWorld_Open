...
public class GuiQuest extends GuiScreen
{
    ...
    final String m_earlyPage = "content";


    public GuiQuest(EntityPlayer player, InventoryPlayer inventory)
    {
        Variable variable = Variable.Instance();
        m_currentPage = variable.selectQuestNumber;
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        //System.out.println("ImageWIDTH = " + bookBackgroundWidth + "   Height = " + bookBackgroundHeight);
