...
public class GuiDialog extends GuiScreen
{
    ...
    public GuiDialog(String name, int min, int max)
    {
        this.name = name;
        m_min = min;
        m_max = max;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        minecraft.renderEngine.bindTexture(new ResourceLocation(GroundWorld.RESOURCEID, "textures/guis/dialog/"+name+"_"+currnet+".png"));
