...
public class BtnCall extends GuiButton
{

    public String m_BtnName = "";
    public float m_Alpha = 0f;
    public BtnCall(int buttonId, int x, int y, String buttonText, String btnName)
    {
    ...
    public BtnCall(int buttonId, int x, int y, String buttonText) {
        super(buttonId, x, y, buttonText);
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if(!m_BtnName.equals("뒤로가기"))
        {
            ...
            {
                mc.renderEngine.bindTexture(new ResourceLocation(GroundWorld.RESOURCEID, "textures\\gui\\phone\\call\\btn\\"+m_BtnName+"_hover.png"));
                drawTexture(this.x, this.y, currutionWidth, currutionHeight, 0, 0, 1, 1, 3, 1f);
            }
            else
            {
                mc.renderEngine.bindTexture(new ResourceLocation(GroundWorld.RESOURCEID, "textures\\gui\\phone\\call\\btn\\"+m_BtnName+"_normal.png"));
                drawTexture(this.x, this.y, currutionWidth, currutionHeight, 0, 0, 1, 1, 3, 1f);
            }
