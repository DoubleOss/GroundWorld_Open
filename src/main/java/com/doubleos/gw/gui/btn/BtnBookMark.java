...
public class BtnBookMark  extends GuiButton
{
    ...
    public BtnBookMark(int buttonId, int x, int y, String buttonText) {
        super(buttonId, x, y, buttonText);
    }

    public BtnBookMark(int buttonId, int x, int y, int width, int height, String buttonText, String resourceName)
    {
        super(buttonId, x, y, buttonText);
        this.width = width;
        this.height = height;
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        ...
        float buttonImageWidth = 80 / 2 * rescalePosition;
        float buttonImageHeight = 459 / 2 * rescalePosition;

        float buttonImageActiveWidth = 80 / 2 * rescalePosition;
        float buttonImageActiveHeight = 529 / 2 * rescalePosition;
        ...
        if(!isActive)
        {
            minecraft.renderEngine.bindTexture(new ResourceLocation(Reference.MODID, "textures/gui/info_book/btn/bookmark.png"));
            drawTexture(x, y, buttonImageWidth, buttonImageHeight, 0, 0, 1, 1, 1 ,1);
        }
        else
        {
            minecraft.renderEngine.bindTexture(new ResourceLocation(Reference.MODID, "textures/gui/info_book/btn/bookmark_active.png"));
            drawTexture(x, y+5, buttonImageActiveWidth, buttonImageActiveHeight, 0, 0, 1, 1, 5 ,1);
        }
