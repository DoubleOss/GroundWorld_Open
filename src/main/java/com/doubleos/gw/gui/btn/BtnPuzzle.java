...
public class BtnPuzzle extends GuiButton
{

    public String m_resourceName = "";
    public BtnPuzzle(int buttonId, int x, int y, int width, int height, String buttonText, String resourceName)
    {
    ...
    public BtnPuzzle(int buttonId, int x, int y, int width, int height, String buttonText)
    {
        super(buttonId, x, y, buttonText);
        this.width = width;
        this.height = height;
    ...
    {
        mc.renderEngine.bindTexture(new ResourceLocation(Reference.MODID, "textures/gui/game/gear/"+m_resourceName+".png"));
