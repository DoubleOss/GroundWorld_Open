...
public class CPacketMailData implements IMessage, IMessageHandler<CPacketMailData, CPacketMailData>
{
    ...
    public CPacketMailData(){}

    public CPacketMailData(int id, String title, String text, String date, boolean active, boolean readActive, String recivePlayerName,
    ...
    @Override
    public CPacketMailData onMessage(CPacketMailData message, MessageContext ctx)
    {
        ...
        Minecraft.getMinecraft().addScheduledTask(()->
        {
            ...
            System.out.println(message.m_mailId + " 도착");
