...
public class BlockSubWayUnLock extends BlockDirectional implements IHasModel, IObjModel, ITileEntityProvider
{
    ...
    public BlockSubWayUnLock(String name, Material blockMaterialIn, boolean unbreaking)
    {
