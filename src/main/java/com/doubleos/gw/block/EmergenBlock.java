...
public class EmergenBlock extends BlockDirectional implements IHasModel, IObjModel, ITileEntityProvider
{
    ...
    public EmergenBlock(String name, Material blockMaterialIn, boolean unbreaking)
    {
