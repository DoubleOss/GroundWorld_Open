...
public class BlockCardReader extends BlockDirectional implements IHasModel, IObjModel, ITileEntityProvider
{
    ...
    public BlockCardReader(String name, Material blockMaterialIn, boolean unbreaking)
    {
