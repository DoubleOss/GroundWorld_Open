...
public class EntityGeoAutoMine5 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("robotstanding2", true));
    ...
    public EntityGeoAutoMine5(World worldIn) {
        super(worldIn);
