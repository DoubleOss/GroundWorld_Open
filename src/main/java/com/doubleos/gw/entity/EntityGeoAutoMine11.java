...
public class EntityGeoAutoMine11 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("standing11", true));
    ...
    public EntityGeoAutoMine11(World worldIn) {
        super(worldIn);
