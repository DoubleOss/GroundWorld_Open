...
public class EntityGeoAutoMine extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("robotstranding1", true));
    ...
    public EntityGeoAutoMine(World worldIn) {
        super(worldIn);
