...
public class EntityGeoAutoMine8 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("standing8", true));
    ...
    public EntityGeoAutoMine8(World worldIn) {
        super(worldIn);
