...
public class EntityGeoAutoMine10 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("standing10", true));
    ...
    public EntityGeoAutoMine10(World worldIn) {
        super(worldIn);
