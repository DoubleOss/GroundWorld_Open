...
public class EntityShop6 extends EntityVillager implements IAnimatable, IAnimationTickable, IEntityShop
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("animation.st_robo_6", true));
    ...
    public EntityShop6(World worldIn) {
        super(worldIn);
