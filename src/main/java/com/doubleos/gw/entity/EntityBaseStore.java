...
public class EntityBaseStore extends EntityVillager implements IAnimatable, IAnimationTickable
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("basestoreidle", true));
    ...
    public EntityBaseStore(World worldIn) {
        super(worldIn);
