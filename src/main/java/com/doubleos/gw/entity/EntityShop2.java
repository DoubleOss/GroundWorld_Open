...
public class EntityShop2 extends EntityVillager implements IAnimatable, IAnimationTickable, IEntityShop
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("st_robo2", true));
    ...
    public EntityShop2(World worldIn) {
        super(worldIn);
