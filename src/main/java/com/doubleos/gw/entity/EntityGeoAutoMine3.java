...
public class EntityGeoAutoMine3 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("robotstranding3", true));
    ...
    public EntityGeoAutoMine3(World worldIn) {
        super(worldIn);
