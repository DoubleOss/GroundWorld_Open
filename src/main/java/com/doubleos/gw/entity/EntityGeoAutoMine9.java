...
public class EntityGeoAutoMine9 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("standing9", true));
    ...
    public EntityGeoAutoMine9(World worldIn) {
        super(worldIn);
