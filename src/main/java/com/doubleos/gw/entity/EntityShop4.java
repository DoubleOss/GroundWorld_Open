...
public class EntityShop4 extends EntityVillager implements IAnimatable, IAnimationTickable, IEntityShop
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("st_robo4", true));
    ...
    public EntityShop4(World worldIn) {
        super(worldIn);
