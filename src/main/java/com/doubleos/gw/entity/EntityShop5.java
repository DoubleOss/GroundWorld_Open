...
public class EntityShop5 extends EntityVillager implements IAnimatable, IAnimationTickable, IEntityShop
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("animation.st_robo_5", true));
    ...
    public EntityShop5(World worldIn) {
        super(worldIn);
