...
public class EntityGeoAutoMine4 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("robotstanding4", true));
    ...
    public EntityGeoAutoMine4(World worldIn) {
        super(worldIn);
