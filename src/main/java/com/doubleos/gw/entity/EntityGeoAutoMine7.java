...
public class EntityGeoAutoMine7 extends EntityVillager implements IAnimatable, IAnimationTickable, AutoMine
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("standing7", true));
    ...
    public EntityGeoAutoMine7(World worldIn) {
        super(worldIn);
