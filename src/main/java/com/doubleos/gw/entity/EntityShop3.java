...
public class EntityShop3 extends EntityVillager implements IAnimatable, IAnimationTickable, IEntityShop
{
    ...
    private <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        event.getController().setAnimation((new AnimationBuilder()).addAnimation("st_robo3", true));
    ...
    public EntityShop3(World worldIn) {
        super(worldIn);
