...
public class InventoryContainer extends Container
{
    ...
    public InventoryContainer(InventoryPlayer playerInventory, EntityPlayer player)
    {
        ...
        this.player = player;
        this.addSlotToContainer(new SlotCrafting(playerInventory.player, this.craftMatrix, this.craftResult, 0, 179, 22));

        for (int i = 0; i < 2; ++i)
        {
            for (int j = 0; j < 2; ++j)
            {
                this.addSlotToContainer(new Slot(this.craftMatrix, j + i * 2, 104 + j * 24, 9 + i * 24));
            }
        }
        ...
        for (int k = 0; k < 4; ++k)
        {
            ...
            this.addSlotToContainer(new Slot(playerInventory, 36 + (3 - k), -16, 67 - 24 * (3-k))
            {
        ...
        int[] widthList = new int[] {71, 95, 119, 143, 167, 191, 215, 239, 263};
        ...
        for(int i=0; i <heightList.length; i++)
        {
            ...
            {
                this.inventorySlots.get(loopCount).xPos = (int)(widthList[j] - 87);
        ...
        widthList = new int[] {71, 95, 119, 143, 167, 191, 215, 239, 263};
        ...
        this.addSlotToContainer(new Slot(playerInventory, 40, 76,  67 - 24 * 0)
        {
            @Nullable
            @SideOnly(Side.CLIENT)
            public String getSlotTexture()
        ...
        GroundWorld.instance.inventoryContainer = this;
    }
